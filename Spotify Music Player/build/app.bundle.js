...
$(function () {
    ...
    $("#container").on('click', '#search', function (event) {
        ...
        userSearch(searchItem).then(function (tracks) {
            console.log(tracks);
            renderTracks(tracks);
        });
    });
    ...
    function renderTracks(trackList) {
        ...
        trackList.tracks.items.forEach(function (element, index) {
            ...
            var track = $('<p>' + count++ + ".  " + trackList.tracks.items[index].name + '</p>').attr('id', trackImage).append(buttonStart);
    ...
    function userSearch(searchItem) {
        return fetch("https://api.spotify.com/v1/search?q=" + searchItem + "&type=track").then(function (res) {
            return res.json();
        }).then(function (data) {
    ...
    function renderLayout() {
        ...
        grid.append($('<div>').addClass("title").text("Spotify Music Player")).append($('<div>').addClass("placeHolder")).append('<br>').append($('<div>').append(boxSearch)).append($('<div>').addClass("btnBox").append(buttonSearch)).append('<br>');
